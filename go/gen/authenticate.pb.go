...
const file_protobuf_authenticate_proto_rawDesc = "" +
	"\n" +
	"\x1bprotobuf/authenticate.proto\",\n" +
	"\fAuthenticate\x12\x1c\n" +
	"\tsignature\x18\x01 \x01(\tR\tsignatureb\x06proto3"

var (
	file_protobuf_authenticate_proto_rawDescOnce sync.Once
	file_protobuf_authenticate_proto_rawDescData []byte
)

func file_protobuf_authenticate_proto_rawDescGZIP() []byte {
	file_protobuf_authenticate_proto_rawDescOnce.Do(func() {
		file_protobuf_authenticate_proto_rawDescData = protoimpl.X.CompressGZIP(unsafe.Slice(unsafe.StringData(file_protobuf_authenticate_proto_rawDesc), len(file_protobuf_authenticate_proto_rawDesc)))
	})
...
var file_protobuf_authenticate_proto_goTypes = []any{
...
func file_protobuf_authenticate_proto_init() {
	...
	out := protoimpl.TypeBuilder{
		File: protoimpl.DescBuilder{
			...
			RawDescriptor: unsafe.Slice(unsafe.StringData(file_protobuf_authenticate_proto_rawDesc), len(file_protobuf_authenticate_proto_rawDesc)),
			NumEnums:      0,
			NumMessages:   1,
			NumExtensions: 0,
			NumServices:   0,
